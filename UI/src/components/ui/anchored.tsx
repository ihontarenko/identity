 ...
 * <h2>Browser floor</h2>
 *
 * CSS anchor positioning is Chromium-only today (Chrome 125+; this application runs on 151). The
 * alternative was a positioner that is wrong in every browser, so the floor is the better trade. When
 * Firefox and Safari ship it, nothing here changes.
 *
 * ⚠️ **Ported verbatim from `Tessera/UI`, where this was built and measured.** Identity carries the
 * same font-scale `zoom` and hit the same bug — a select on the access screen opened its list on top
 * of the table below it. Keep the two copies identical: a fix to one belongs in the other.
 */
